    ...
    <div css={styles.about} id="about">
      ...
      <div css={styles.aboutContent}>
        ...
        <p css={styles.aboutParagraph}>
          You might as well learn a bit more about me. My passion for math,
          solving problems, and creating things, led me to learn software
          engineering. I am highly organized and love to simplify and optimize
          my workflow as well as my life. Another passion of mine is running and
          coaching. I strive to enjoy life and do some good along the way.
        </p>
